...
class KittiConverter:
    def __init__(self,
        ...
        self.nusc = NuScenes(dataroot='/home/hpaat/pcdet/data/nuscenes/v1.0-trainval', version=nusc_version)
    ...
    def nuscenes_gt_to_kitti(self) -> None:
        ...
        tokens = []
        for sample_token in tqdm(sample_tokens, position=0, leave=True, desc = 'Generating labels in kitti format'):
