...
class NuScenes:
    ...
    def map_pointcloud_to_image(self, pointsensor_token: str, camera_token: str, min_dist: float = 1.0, 
                                render_intensity: bool = False, show_lidarseg: bool = False, filter_lidarseg_labels: List = None,
                                lidarseg_preds_bin_path: str = None, show_panoptic: bool = False) -> Tuple:
        points, coloring, im, mask, pts3d = self.explorer.map_pointcloud_to_image(pointsensor_token, camera_token, min_dist, render_intensity,
                                                                           show_lidarseg, filter_lidarseg_labels, lidarseg_preds_bin_path,
                                                                           show_panoptic)
        return points, coloring, im, mask, pts3d
...
class NuScenesExplorer:
    ...
    def map_pointcloud_to_image(self,
        ...
        if True:
            ...
            return points, coloring, im, None, None
